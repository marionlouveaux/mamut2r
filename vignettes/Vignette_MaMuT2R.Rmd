...
vignette: >
  %\VignetteIndexEntry{Vignette MaMuT2R - getting started}
...
```{r}
fileXML_BDV <- xmlToList("MaMuT_Parhyale_demo.xml")
# xmlToList(system.file("extdata", "MaMuT_Parhyale_demo.xml", package = "mamut2r"))
```


```{r}
Registration_df <- read_ViewRegistration(MaMuT_XML_BDV, 12, setup = 0)
...
```{r, eval=FALSE}
library(rgl)
plot3d(Spots_df_tmp[which(Spots_df_tmp$FRAME == 0),
